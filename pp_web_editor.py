...
class PPWebEditor(App):
    ...
    def main(self):
        ...
        track_new_mpv_menu = gui.MenuItem('MPV Video/Audio',width=120, height=30)
        ...
        track_new_webkit_menu = gui.MenuItem( 'WebKit Web',width=120, height=30)
        track_new_webkit_menu.set_on_click_listener(self.new_webkit_track)
        ...
        track_new_menu.append(track_new_webkit_menu)        
    ...
    def show_help (self,widget):
        OKDialog("Help","Please Read pipresents/manual.pdf'",width=400,height=200).show(self)
    ...
    def new_exhibit_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_exhibit_1p6'
        self.new_profile(profile)

    def new_interactive_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_interactive_1p6'
        self.new_profile(profile)

    def new_menu_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_menu_1p6'
        self.new_profile(profile)

    def new_presentation_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_presentation_1p6'
        self.new_profile(profile)

    def new_blank_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep +"ppt_blank_1p6"
        self.new_profile(profile)

    def new_mediashow_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_mediashow_1p6'
        self.new_profile(profile)
        
    def new_liveshow_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_liveshow_1p6'
        self.new_profile(profile)

    def new_artmediashow_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_artmediashow_1p6'
        self.new_profile(profile)
        
    def new_artliveshow_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_artliveshow_1p6'
        self.new_profile(profile)

    def new_radiobuttonshow_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_radiobuttonshow_1p6'
        self.new_profile(profile)

    def new_hyperlinkshow_profile(self,widget):
        profile = self.editor_dir+os.sep+'pp_resources'+os.sep+'pp_templates'+os.sep + 'ppt_hyperlinkshow_1p6'
        self.new_profile(profile)
    ...
    def new_webkit_track(self,widget):
        self.new_track(PPdefinitions.new_tracks['webkit'],None)
    ...
    def add_track(self,file_path):
        ...
        if ext.lower() in PPdefinitions.IMAGE_FILES:
            ...
            self.new_track(PPdefinitions.new_tracks['webkit'],{'title':title,'track-ref':'','location':location})
        else:
