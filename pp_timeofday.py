...
class TimeOfDay(object):
    ...
    def poll(self):
        ...
        # run in a loop to catch up because timeout_add can get behind when images are being rendered etc.
        ...
        # and loop
        if self.testing:
            self.tick_timer=GLib.timeout_add(1000,self.poll)
            return False
        else:
            self.tick_timer=GLib.timeout_add(self.tod_tick,self.poll)
            return False
