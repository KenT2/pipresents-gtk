            ...
            if self.quit_signal is True or (self.duration != 0 and self.duration_count == 0):
                ...
                if self.freeze_at_end =='yes':
                    ...
                    if self.finished_callback is not None:
                        ...
                        GLib.timeout_add(50, self.show_state_machine)
                else:
                ...
                self.tick_timer=GLib.timeout_add(50, self.show_state_machine)
...
# ***********************
    ...
    def execute_command(self):
        if self.command_timer != None:
            self.source_remove(self.command_timer)
            self.command_timer=None
    ...
    def process_chrome_window(self,line):
        ...
        if len(words)==1 and words[0] == 'kiosk':
            ...
            #x_org,y_org=self.dm.real_display_position(self.display_name)
        ...
        if words[0] == 'display':
            ...
            x_org=0
            y_org=0
            width,height= self.dm.get_real_display_dimensions(self.display_id)
